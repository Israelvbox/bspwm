...
function banner(){
	...
	sleep 0.05
	echo -e " /______      ___  /___________________      ________ ___"
	sleep 0.05
	echo -e "     __  __ \_  ___/__  __ \_ | /| / /_  __ \`__ \\"
	sleep 0.05
	echo -e "     _  /_/ /(__  )__  /_/ /_ |/ |/ /_  / / / / /"
	sleep 0.05
	echo -e "      /_.___//____/ _  .___/____/|__/ /_/ /_/ /_/    ${endColour}${yellowColour}(${endColour}${grayColour}By ${endColour}${purpleColour}@r1vs3c${endColour}${yellowColour})${endColour}${turquoiseColour}"
	sleep 0.05
    	echo -e "                                             /_/${endColour}"
}
